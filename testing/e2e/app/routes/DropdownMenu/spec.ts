...
test.describe('Nested DropdownMenu', () => {
  test('should support deep level submenus', async ({ page }) => {
    ...
    await page.keyboard.press('ArrowRight');
    expect(page.getByTestId('Item 4_1')).toBeFocused();

    await page.keyboard.press('ArrowDown');
    expect(page.getByTestId('Item 4_2')).toBeFocused();
    ...
    expect(page.getByTestId('Item 4_1')).toBeHidden();
    expect(page.getByTestId('Item 4_2')).toBeHidden();
    ...
    await page.getByTestId('Item 4_2').hover();
    expect(page.getByTestId('Item 4_2')).toBeFocused();
  });
});
