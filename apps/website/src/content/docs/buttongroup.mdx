...
The `ButtonGroup` should almost always be used with [`IconButton`](button#iconbutton) components. Make sure to also use the `label` prop to each `IconButton`; this text will be used to label the button and will be displayed in a tooltip.
