...
This property is a function that takes the step index and returns the custom content to represent the status of each step. One of the most common usage for this customization is to indicate step completion.
