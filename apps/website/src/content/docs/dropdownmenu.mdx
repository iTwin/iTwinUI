...
Similar to the [`Popover`](/docs/popover) component, the dropdown menu can be hidden when the trigger gets hidden. This could be useful when the trigger is in a scrollable container.
