...
Useful for having a borderless `ExpandButton`, for example. `ExpandButton` [subcomponents](#subcomponents) inside a borderless `CollapsedState` will have a default to [borderless](button#borderless).

<LiveExample src='SearchBox.borderlesscollapsedstate.jsx'>
  <AllExamples.SearchBoxBorderlessCollapsedStateExample client:load />
</LiveExample>
