...
Useful for having a borderless `ExpandButton`, for example. `ExpandButton` [subcomponents](#subcomponents) inside a borderless `CollapsedState` will default to [borderless](button#borderless).
