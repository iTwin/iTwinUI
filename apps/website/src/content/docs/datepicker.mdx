...
This example and the others under this heading use the Popover utility component to show a real world use case.

<LiveExample src='DatePicker.basic.jsx' truncate={true}>
  <AllExamples.DatePickerBasicExample client:load />
</LiveExample>

If you would rather see an example of the date picker being used on its own, look at the <a href="#standalone-usage">standalone usage</a> example.
