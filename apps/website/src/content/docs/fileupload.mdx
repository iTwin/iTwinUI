...
<LiveExample src='FileUpload.main.tsx'>
...
You can upload files using `FileUploadCard` and `FileEmptyCard` with subcomponents that are fully customizable.
...
Drag and Drop Files along with an input.

<LiveExample src='FileUpload.wrappinginput.tsx'>
  <AllExamples.FileUploadWrappingInputExample client:load />
</LiveExample>

### Custom File Upload Card

Change standard file upload card by adding custom label and text.

<LiveExample src='FileUpload.custom.tsx'>
