---
title: LinkAction
description: Helps create accessible block links.
thumbnail: Anchor
group: utilities
---
...
If your container includes other elements that should be clickable, you can set `position: relative` on them or give them a higher z-index.
