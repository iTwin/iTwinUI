...
Additionally, to implement further actions upon the closing of each toast or to chain one toast after another, you can retrieve the `close()` function returned from the status method.
