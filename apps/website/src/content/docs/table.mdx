...
**Note**: For accessibility reasons, in single-selection Tables, it is highly recommended to include a button in each selectable row. [More info](https://github.com/iTwin/iTwinUI/issues/2130#issuecomment-2209287280).
