...
Since clicking the row selects it, you may need to stop click event propagations in the rows' children to prevent the row from being selected when clicking on its children.
