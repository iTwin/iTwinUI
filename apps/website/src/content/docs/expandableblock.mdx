...
`ExpandableBlock` consists of subcomponents, which include but are not limited to the following.

### ExpandableBlock.Wrapper

`ExpandableBlock.Wrapper` should contain the `ExpandableBlock` and the component over which the block will overlay.

<PropsTable path='@itwin/itwinui-react/esm/core/ExpandableBlock/ExpandableBlockWrapper.d.ts' />

### ExpandableBlock.Content

The `ExpandableBlock.Content` component is used for the content shown in the block's body when fully expanded.

<PropsTable path='@itwin/itwinui-react/esm/core/ExpandableBlock/ExpandableBlockContent.d.ts' />

### ExpandableBlock.Trigger

`ExpandableBlock.Trigger` is the `Header` container that contains `ExpandIcon`, `LabelArea` and `EndIcon` subcomponents.

<PropsTable path='@itwin/itwinui-react/esm/core/ExpandableBlock/ExpandableBlockTrigger.d.ts' />
