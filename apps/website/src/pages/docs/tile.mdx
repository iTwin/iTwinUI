...
You can also take advantage of props provided for `Tile`. A list of available props can be found [at the end](#props) of this page.
...
Tile can also link to another page. Add `href` prop to the Tile.Action to make whole tile an anchor link.
