...
Alternatively, you can use Alerts directly with type, onClick. Although this pattern can suffice for simple cases, we strongly recommend using composition API for the best experience.
