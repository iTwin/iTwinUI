...
- One high visibility button per section (e.g. in a modal dialog, or above the table).
- One CTA button on a page at a time and should always appear within a dedicated page footer.
- Icon buttons should not have be high visibility or CTA styletypes.
