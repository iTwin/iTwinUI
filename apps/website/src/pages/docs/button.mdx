...
propsPathIdeasButton: '@itwin/itwinui-react/esm/core/Buttons/IdeasButton/IdeasButton.d.ts'
propsPathDropdownButton: '@itwin/itwinui-react/esm/core/Buttons/DropdownButton/DropdownButton.d.ts'
thumbnail: Button
group: buttons
---
