...
An expandable block can be one of two sizes: default and small
...
The borderless expandable block is useful in tighter areas where using a default expandable block would visibly cause too many blocks.
