...
A placement dialog can be adjusted to sit in one of the four corners of the page.

<LiveExample src='Dialog.placement.tsx'>
  <AllExamples.DialogPlacementExample client:load />
</LiveExample>

Positions for the dialog on the page include:
