...
<LiveExample src='Dialog.main.tsx'>
...
<LiveExample src='Dialog.modal.tsx'>
...
<LiveExample src='Dialog.dismissible.tsx'>
...
<LiveExample src='Dialog.nondismissible.tsx'>
...
<LiveExample src='Dialog.draggable.tsx'>
  <AllExamples.DialogDraggableExample client:load />
</LiveExample>

### Draggable Within a Container 

You can also create a draggable dialog bounded within a container. The container must have `position: 'relative'` set.

<LiveExample src='Dialog.draggablecontainer.tsx'>
  <AllExamples.DialogDraggableContainerExample client:load />
</LiveExample>
...
<LiveExample src='Dialog.fullpage.tsx'>
