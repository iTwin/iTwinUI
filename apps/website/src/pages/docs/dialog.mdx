...
exampleCodeModal: Dialog.modal.tsx
thumbnail: Dialog
group: core
---
...
- Dialog: a dialog is the box of content that appears above the rest of the page content. The user can still interact with the page content.
...
<LiveExample src={frontmatter.exampleCodeModal} />
