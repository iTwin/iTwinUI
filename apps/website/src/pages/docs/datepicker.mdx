...
<Placeholder componentPageName='core-datepicker' />
...
The basic date picker consists of a default menu button from which an interactive calendar expands on click.
...
If you need to include the time, there are multiple ways to do so. Below is the default variant, which uses twenty-four hour / military time.
