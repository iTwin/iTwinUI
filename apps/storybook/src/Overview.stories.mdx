...
import itwinuiLight from '../.storybook/public/itwin.svg';
import itwinuiDark from '../.storybook/public/itwin-dark.svg';
...
<center>
  <h1>
    <picture>
      <source media='(prefers-color-scheme: dark)' srcSet={itwinuiDark} />
      <img src={itwinuiLight} alt='iTwinUI logo' />
    </picture>
  </h1>
</center>

| ⚠️ This is the storybook for iTwinUI-react v2. For the latest version, please visit [https://itwin.github.io/iTwinUI](https://itwin.github.io/iTwinUI). |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- |

## What is iTwinUI-react?

iTwinUI-react is a React component library for [iTwinUI](https://github.com/iTwin/iTwinUI).
The goal of this project is to provide React components that make it easier to use the styles from [`@itwin/itwinui-css`](https://github.com/iTwin/iTwinUI/tree/main/packages/itwinui-css).
