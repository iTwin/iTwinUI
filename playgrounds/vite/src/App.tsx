...
const App = () => {
  return (
    <Flex flexDirection='column' gap='l' alignItems='stretch'>
      ...
      <Section title='Magic numbers of searchbox-icon padding'>
        <SectionSubtitle>Small</SectionSubtitle>
        <SearchBox size='small'>
          <SearchBox.CollapsedState />
          <SearchBox.ExpandedState>
            <SearchBox.Icon
        ...
        <SectionSubtitle>Default</SectionSubtitle>
        <SearchBox>
          <SearchBox.CollapsedState />
          <SearchBox.ExpandedState>
            <SearchBox.Icon style={{ backgroundColor: 'hotpink' }} />
            <SearchBox.Input />
            <SearchBox.CollapseButton />
          </SearchBox.ExpandedState>
        </SearchBox>
        ...
        <SearchBox>
          ...
          <SearchBox.ExpandedState>
            {/* <SearchBox.Icon /> */}
            <SearchBox.CollapseButton style={{ backgroundColor: 'hotpink' }} />
            <SearchBox.Input />
            <SearchBox.CollapseButton />
          </SearchBox.ExpandedState>
        </SearchBox>

        <SectionSubtitle>Large</SectionSubtitle>
        <SearchBox size='large'>
          <SearchBox.CollapsedState />
          <SearchBox.ExpandedState>
            <SearchBox.Icon
