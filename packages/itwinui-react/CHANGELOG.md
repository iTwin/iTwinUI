...
- [#2205](https://github.com/iTwin/iTwinUI/pull/2205): `BaseFilter` now renders as a `<form>` and `FilterButtonBar` now renders a `<button type="submit">`. Together, this enables the use of browser's built-in validation before applying filters. The `setFilter` prop in `FilterButtonBar` has been deprecated, as `onSubmit` should be used instead.
...
- [#2169](https://github.com/iTwin/iTwinUI/pull/2169): Bumped the minimum version of `@floating-ui/react` to `0.26.23`.
- [#2040](https://github.com/iTwin/iTwinUI/pull/2040): Added hover state to disabled button, select, input, textarea, and actionable list item to help with accessibility.
