...
var useImperativeHandle = (react_production_min.useImperativeHandle = function (
  a,
  b,
  e,
) {
...
var useInsertionEffect = (react_production_min.useInsertionEffect = function (
  a,
  b,
) {
...
var useSyncExternalStore = (react_production_min.useSyncExternalStore =
  function (a, b, e) {
...
const scheduler_production_min = /*@__PURE__*/ getDefaultExportFromCjs(
  scheduler_production_min$1,
);
...
var unmountComponentAtNode = (reactDom_production_min.unmountComponentAtNode =
  function (a) {
...
var unstable_batchedUpdates = (reactDom_production_min.unstable_batchedUpdates =
  Rk);
var unstable_renderSubtreeIntoContainer =
...
var version = (reactDom_production_min.version =
...
async function __pwResolveComponent(component) {
  ...
  if (
    !componentFactory &&
    component.type[0].toUpperCase() === component.type[0]
  )
    throw new Error(
  ...
  if ('children' in component)
    await Promise.all(
      component.children.map((child) => __pwResolveComponent(child)),
    );
}
...
window.playwrightUnmount = async (rootElement) => {
  ...
  if (root === undefined) throw new Error('Component was not mounted');
